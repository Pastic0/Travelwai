...
public interface IDataRepository
{
    ...
    Task<int> UpdateWhereEqualAsync(string collection, string field, object value, Dictionary<string, object?> data);
    Task<int> UpdateWhereEqualAndInAsync(string collection, string equalField, object equalValue, string inField, IReadOnlyCollection<string> values, Dictionary<string, object?> data);
    Task<int> DeleteWhereEqualAndInAsync(string collection, string equalField, object equalValue, string inField, IReadOnlyCollection<string> values);
