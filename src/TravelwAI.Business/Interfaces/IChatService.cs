...
public interface IChatService
{
    ...
    Task<ChatMessageSendResult> SendMessageAsync(string conversationId, string senderId, string content);
    ...
    Task<ChatConversationDeleteResult> DeleteConversationAsync(string conversationId, string userId);
...
public sealed record ChatConversationDeleteResult(
    bool Success,
    string Action,
