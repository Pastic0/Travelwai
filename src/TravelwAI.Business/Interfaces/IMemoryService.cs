...
{
    Task<string?> CreateMemoryAsync(string userId, string memoryName, string description, string province, string createdAt, List<string> sharedEmails, string? photoUrl, List<string>? photoUrls = null, List<string>? videoUrls = null);
