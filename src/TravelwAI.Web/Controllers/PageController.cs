...
public sealed class PageController : Controller
{
    ...
    public IActionResult LocationAnalysis() => View("LocationAnalysis");
    ...
    public IActionResult LegacyTourManagement() => Redirect("/business");

    [HttpGet("/tour-sales")]
    public IActionResult LegacyTourSales() => Redirect("/business");
