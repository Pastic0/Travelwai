(function () {
  ...
  const PAGES = [
    ...
    { name: "Hỗ trợ Admin", url: "/messaging?admin=1", aliases: ["lien he admin", "ho tro", "nhan tin admin", "chat admin"], detail: "Mở hội thoại với Admin." },
    ...
    { name: "Business", url: "/business", aliases: ["business", "company", "sales", "trang business", "trang company", "trang sales", "kinh doanh", "ban tour", "don ban tour", "tour sales", "tour-sales"], detail: "Quản lý tour, đơn bán tour và doanh thu." },
