        ...
        CancellationToken cancellationToken)
    {
        ...
        var systemPrompt = useEnglish
            ? "You are an expert in travel-image and food-image recognition. Accuracy is more important than always producing an answer. " +
              ...
              "For content_type='food', identify only the visible food or beverage. Do not infer a landmark, province, city, holiday, or festival. Leave landmark, address, district, province, country, and landmarks empty. " +
            ...
            : "Bạn là chuyên gia nhận diện hình ảnh du lịch và ẩm thực, ưu tiên chính xác hơn việc luôn đưa ra đáp án. " +
              ...
              "Với content_type='food', chỉ nhận diện món ăn hoặc đồ uống nhìn thấy trong ảnh; không suy đoán địa danh, tỉnh thành, ngày lễ hoặc lễ hội. Các trường landmark, address, district, province, country và landmarks phải để rỗng. " +
              ...
              "Cấu trúc bắt buộc: " +
              "{\"content_type\":\"landmark|food|unknown\",\"location_status\":\"exact|probable|unknown\",\"confidence_score\":0,\"confidence\":\"cao|trung bình|thấp\",\"title\":\"tên địa danh, tên món ăn hoặc Chưa xác định\",\"landmark\":\"tên địa danh chính hoặc rỗng\",\"address\":\"địa chỉ chắc chắn hoặc rỗng\",\"district\":\"quận huyện chắc chắn hoặc rỗng\",\"province\":\"tỉnh thành chắc chắn hoặc rỗng\",\"country\":\"quốc gia chắc chắn hoặc rỗng\",\"summary\":\"kết luận ngắn, chỉ nói về đúng loại nội dung đã chọn\",\"image_description\":\"mô tả chi tiết toàn bộ ảnh trong 2 đến 4 câu\",\"landmarks\":[\"địa danh có căn cứ\"],\"foods\":[\"món ăn hoặc đồ uống nhìn thấy\"],\"observations\":[\"chi tiết thị giác cụ thể\"],\"identification_basis\":[\"dấu hiệu trực tiếp giúp nhận diện\"]}. " +
